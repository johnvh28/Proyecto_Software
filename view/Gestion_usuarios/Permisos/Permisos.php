                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Lista de roles con permisos</h3>
                            <div class="align-content-end text-right">
                                <a href="index.php?c=usuario&a=AsignarPermisos" class="btn btn-success">Asignar Permisos</a>
                            </div>
                                ...
                                <tbody>
                                    <?php foreach ($Usuarios['usuarios'] as $usuario) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $usuario['cantidad_permisos'] ?></td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" class="dropdown-item" data-toggle="modal" data-target="#Activar<?php echo $usuario['id_usuario']; ?>"><i class="fas fa-eye"></i>Ver permisos</button>
                                                    <a class="dropdown-item" href="index.php?c=usuario&a=actualizarpermisos&id=<?php echo $usuario['id_usuario']; ?>"><i class="fas fa-edit"> </i>Agregar nuevo permisos</a>

                                                    <a class="dropdown-item"  href="index.php?c=usuario&a=eliminarpermisos&id=<?php echo $usuario['id_usuario']; ?>"><i class="fas  fa-trash"></i>Eliminar permiso</a>
