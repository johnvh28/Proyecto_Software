            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Asignar Privilegio</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="container">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Asignación de privilegios</h3>
                        </div>
                        <div class="card-body">
                            <form id="crear" name="crear" method="POST" action="index.php?c=usuario&a=GuardarPrivilegio" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <select name="rol" class="select2 form-select-lg shadow-none" style="width: 100%; height:100%" required>
