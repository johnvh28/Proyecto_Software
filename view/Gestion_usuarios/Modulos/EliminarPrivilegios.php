...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="#">Privilegios de roles</a></li>
                        <li class="breadcrumb-item active">Desactivar Privilegio</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    {
        return count($modulo['submodulos']);
    }
                ...
                <div class="container">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Agrega  privilegios</h3>
                        </div>
                        <div class="card-body">
                            <form id="crear" name="crear" method="POST" action="index.php?c=usuario&a=EliminarPrivilegio" autocomplete="off">

                                <div class="form-group row">
                                    <div class="col-md-4">

                                        <label for="nombre" class="form-label">Rol:</label>
                                        <select name="rol" class="select2 form-select-lg shadow-none" style="width: 100%; height:100%" disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label style="font: bold 16px Arial, sans-serif; color:black;" for="categoria">Módulos y Submódulos:</label>
                                            <div class="row">
