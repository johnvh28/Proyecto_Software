            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Asignar Salarios</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Asignar Salario</h3>
                        </div>
                        <div class="container">
                            <form id="crear" name="crear" method="POST" action="index.php?c=negocio&a=GuardarSalario" autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="id" class="select2 form-select-lg shadow-none" style="width: 100%; height:100%">
                                                    <?php foreach ($Empleados['salarios'] as $salario) : ?>
                                                        <option value="<?php echo $salario['id'] ?>"><?php echo "Codigo Empleado: " . $salario['cod_trabajador'] .  " Nombre: " . $salario['nombre'] . " " . $salario['apellido'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="btn-list">
                                        <button type="submit" class="btn btn-success">Asignar Salario</button>
                                    </div>
                                </div>
