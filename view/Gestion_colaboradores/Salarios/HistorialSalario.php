                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="index.php?c=negocio&a=salario" class="btn btn-primary btn-block"><b>Volver Inicio</b></a>
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="post">
                                        ...
                                        <?php
                                        $historialSalarios = $HistorialSalario['historial']["salarios"];
                                            ...
                                            <div class="card mt-3">
                                                <div class="card-body">
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item">
                                                            <strong>Monto del Salario:</strong> <?php echo $salario['salario'] ?>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <strong>Fecha de Registro:</strong> <?php echo $salario['fecha_registro_salario'] ?>
                                                        </li>
                                                        <li class="list-group-item">
                                            ...
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination justify-content-center">
                                                    ...
                                                    <?php if ($paginaActual > 1) : ?>
                                                        <li class="page-item">
                                                            <a class="page-link" href="index.php?c=negocio&a=historialsalario&id=<?php echo $_GET['id'] ?>&pagina=<?php echo $paginaActual - 1; ?>" aria-label="Previous">
                                                    ...
                                                    <?php for ($i = 1; $i <= $totalPaginas; $i++) : ?>
                                                        <li class="page-item <?php echo $i == $paginaActual ? 'active' : ''; ?>">
                                                            <a class="page-link" href="index.php?c=negocio&a=historialsalario&id=<?php echo $_GET['id'] ?>&pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                                                        </li>
                                                    <?php endfor; ?>

                                                    <?php if ($paginaActual < $totalPaginas) : ?>
                                                        <li class="page-item">
                                                            <a class="page-link" href="index.php?c=negocio&a=historialsalario&id=<?php echo $_GET['id'] ?>&pagina=<?php echo $paginaActual + 1; ?>" aria-label="Next">
