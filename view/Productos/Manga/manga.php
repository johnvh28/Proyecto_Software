                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Lista de Mangas</h3>
                            <div class="align-content-end text-right">
                                <a href="index.php?c=productos&a=crearManga" class="btn btn-success">Registrar Manga</a>
                            </div>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($data['Listas'] as $manga) : ?>
                                        <tr>
                                            <td><?php echo $manga['nombre'] ?></td>
                                            <td><?php echo $manga['descripcion'] ?></td>
                                            <td>
                                                <?php if ($manga['estado'] == 1) : ?>
                                                    <span class="badge rounded-pill bg-success" style="font: bold 12px Arial, sans-serif; color:white;">Activo</span></span>
                                                <?php elseif ($manga['estado'] == 2) : ?>
                                            ...
                                            <td>
                                                <div class="btn-list m-2">
                                                    <a class="btn btn-success m-2" href="index.php?c=productos&a=ActualizaManga&id=<?php echo $manga['id']; ?>">Editar</a>
                                                    <button type="button" class="btn btn-danger m-2" data-toggle="modal" data-target="#Eliminar<?php echo $manga['id']; ?>">Eliminar</button>
                                                </div>
        ...
        <div class="modal" tabindex="-1" id="Eliminar<?php echo $Eliminar['id']; ?>">
            <div class="modal-dialog modal-md" style="background-color:red;">
                <div class="modal-content" style="background-color:red;">
                    ...
                    <form id="crear" name="crear" method="POST" action="index.php?c=productos&a=EliminarManga" autocomplete="off">
