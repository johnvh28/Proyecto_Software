            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="container">
                            <form id="crear" name="crear" method="POST" action="index.php?c=productos&a=GuadarProductos"  enctype="multipart/form-data" autocomplete="off">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="estado" class="form-label">Subcategoria</label>

                                                <select name="subcategoria" class="select2 form-select-lg shadow-none" style="width: 100%; height:100%">
                                                    <?php foreach ($Categorias['productos'] as $categoria) : ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="nombre" class="form-label">Nombre del</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="foto" type="file" class="form-control" id="descripcion" value=""  accept="image/*" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
