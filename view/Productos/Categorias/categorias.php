                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="align-content-end text-right">
                                <a href="index.php?c=productos&a=crearCategoria" class="btn btn-success">Registrar Categoria</a>
                            </div>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($data['Listas'] as $categoria) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-list m-2">
                                                    <a class="btn btn-success m-2" href="index.php?c=productos&a=ActualizaCategorias&id=<?php echo $categoria['id']; ?>">Editar</a>
                                                    <button type="button" class="btn btn-danger m-2" data-toggle="modal" data-target="#Eliminar<?php echo $categoria['id']; ?>">Eliminar</button>
                                                </div>
                ...
                <div class="modal-content" style="background-color:red;">
                    <div class="modal-header">
                        <h5 style="font: bold 16px Arial, sans-serif; color:black;" class="modal-title" id="myModalTitle">
                            Desactivar categoria?</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="crear" name="crear" method="POST" action="index.php?c=productos&a=EliminarCategoria" autocomplete="off">
                        <div class="modal-body">
                            <h5>¿Estas seguro de desactivar esta categoria?</h5>
